...
class CreateByteClickDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('byte_click_data', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('request_id', 40); //请求下发的id
    ...
    {
        Schema::dropIfExists('byte_click_data');
    }
}
